...
CREATE TABLE `posisi_penulis` (
  ...
  `posisi_pertama` int(255) NOT NULL,
  `Posisi_berikutnya` int(255) NOT NULL,
  `persentase_posisi_berikutnya` varchar(255) NOT NULL,
  `persentase_posisi_pertama` varchar(255) NOT NULL,
  `id_author` int(255) NOT NULL,
